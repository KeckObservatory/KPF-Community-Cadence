...
import { Calibration, MetaData, Observation, OBTarget, ScheduleData } from './module_selector';
        ...
        switch (componentName) {
            ...
            case 'calibration': {
                return <CalibrationForm
                    open={open}
                    calibration={row as Calibration}
