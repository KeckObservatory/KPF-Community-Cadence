...
const useRandomInterval = (callback: Function, minDelay=45, maxDelay=450) => {
...
const Sparkles = ({ color = DEFAULT_COLOR, children, ...delegated }: { color?: string, children: React.ReactNode, [key: string]: any }) => {
...
const Sparkle = ({ size: number, color: string, style }) => {
  const path =
